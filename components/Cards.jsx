  ...
  return (
    <section className='FlexContainer p-2'>
      {members && members.length > 0 ? (
        members.map((m, index) => (
          <div className={`flex flex-col gap-5 justify-center items-center bg-cyan-300 text-center m-4 my-12 md:w-[300px] md:h-[300px] w-[220px] h-[220px] p-[30px] rounded-3xl ${m.status === 'lunas' ? 'opacity-75 bg-gray-400 text-gray-500' : ''}`} key={index}>
